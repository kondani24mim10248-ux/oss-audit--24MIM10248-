...
oss-audit-[roll-number]/ │ ├── README.md ├── scripts/ │ ├── script1_system_identity.sh │ ├── script2_package_inspector.sh │ ├── script3_disk_auditor.sh │ ├── script4_log_analyzer.sh │ └── script5_manifesto.sh │ ├── report/ │ └── OSS_Audit_Report.pdf │ └── screenshots/
